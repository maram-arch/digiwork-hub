-- Backup before SQL merge (auto-generated)
-- Source snapshot: database/digiwork-hub.sql
...
ALTER TABLE `commentaire` ADD PRIMARY KEY (`id-commentaire`);
ALTER TABLE `evente` ADD PRIMARY KEY (`id_event`);
ALTER TABLE `forums` ADD PRIMARY KEY (`id-publication`);
ALTER TABLE `inscription` ADD PRIMARY KEY (`id_inscription`);
ALTER TABLE `offer` ADD PRIMARY KEY (`id-offer`);
ALTER TABLE `pack` ADD PRIMARY KEY (`id-pack`);
ALTER TABLE `projet` ADD PRIMARY KEY (`id-projet`);
ALTER TABLE `sponsor` ADD PRIMARY KEY (`id_user`);
ALTER TABLE `sponsorships` ADD PRIMARY KEY (`id-sponser`);
ALTER TABLE `user` ADD PRIMARY KEY (`id_user`);

ALTER TABLE `evente` MODIFY `id_event` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `inscription` MODIFY `id_inscription` int(11) NOT NULL AUTO_INCREMENT;
