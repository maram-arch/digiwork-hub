...
ALTER TABLE `commentaire`
  ...
  ADD UNIQUE KEY `id-publication` (`id_publication`);
...
--
ALTER TABLE `commentaire`
  ADD CONSTRAINT `commentaire_fks` FOREIGN KEY (`id_publication`) REFERENCES `forums` (`id-publication`) ON DELETE CASCADE ON UPDATE CASCADE;
