...
// Auto-set admin session if not already set
...
// Get recent activity with pack and user details
try {
    ...
    <div class="admin-container">
        <aside class="admin-sidebar">
            ...
            <nav class="admin-sidebar-menu">
                ...
                <a href="managePackEvents.php" class="admin-sidebar-item">
                    <i class="fas fa-link"></i>
                    <span>Relations Pack-Événement</span>
                </a>
                ...
                <div style="margin: 12px 12px 6px; border-top: 1px solid rgba(255,255,255,.12); padding-top: 12px;">
                    <a href="/projet%20web%20diji/diji2/digiwork-hub/view/front/packs.php" class="admin-sidebar-item" style="background:rgba(16,185,129,.08);">
            ...
            <div class="main-content">
                            ...
                            <div class="activity-item">
                                ...
                                <div class="activity-content">
                                    ...
                                    <div class="activity-time">
                                        Client: <?= htmlspecialchars($abo['email']) ?> • 
                ...
                <div style="margin-top: 30px; padding-top: 30px; border-top: 1px solid #dddddd;">
                    ...
                    <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                        ...
                        <a href="http://localhost/projet%20web%20diji/diji2/digiwork-hub/view/front/packs.php" class="btn-outline" style="text-decoration: none; padding: 10px 20px; background: white; color: #00A651; border: 2px solid #00A651; border-radius: 10px; font-weight: 600;">
