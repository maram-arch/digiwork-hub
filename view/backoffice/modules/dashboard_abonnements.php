...
<body>
    ...
    <script>
        ...
        async function loadSubscriptions() {
            try {
                const response = await fetch('/projectttttttt/controller/AbonnementController.php?action=getAll');
        ...
        async function deleteAbo(id) {
            ...
            try {
                ...
                const response = await fetch('/projectttttttt/controller/AbonnementController.php', {
                    method: 'POST',
                    body: formData
                });
