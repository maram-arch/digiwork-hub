...
<section class="section">
  <div class="container">
    <div class="section-header">
      ...
      <a href="/DigiWorkHub/digiwork-hub/index2.php?page=home" class="see-more">Retour Accueil</a>
    </div>
        ...
        <div class="card-body">
          ...
          <div class="card-footer">
            ...
            <div class="card-actions">
              <a href="/DigiWorkHub/digiwork-hub/index2.php?page=projectCRUD" class="mini-btn">
                Voir Projet
              </a>
