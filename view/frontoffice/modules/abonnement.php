...
<body style="background-color: #FFFFFF !important;">
    ...
    if (!isset($_SESSION['user_id'])) {
        ...
        header('Location: /projectttttttt/index.php');
        exit;
    }
    ...
    <script>
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    ...
                                    <p style="color: rgba(255,255,255,0.9); margin: 0; font-size: 14px; line-height: 1.5;">
                                        <div style="margin-bottom: 5px;"><strong>Email :</strong> ${abo.email}</div>
        ...
        function subscribeForm(e, packId) {
            ...
            fetch('/projectttttttt/controller/AbonnementController.php', {
                method: 'POST',
                body: fd
            })
            .then(res => res.json())
