...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_inscription'])) {
    ...
    // Use session user_id if logged in, otherwise NULL (guest)
    ...
    try {
        ...
        $message = '<div style="background-color: #d4edda; color: #155724; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #c3e6cb; font-weight: 500; text-align:center;">✅ Inscription enregistrée avec succès !</div>';
    } catch (Exception $e) {
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="#">Formations</a>
            <a href="#">Durabilité</a>
            <a href="/projectttttttt/index.php?page=events" class="active">Événements</a>
        </div>
    ...
    <div class="page-content">
        <div class="form-container">
            ...
            <?php if (isset($_GET['id_event']) && intval($_GET['id_event']) > 0): ?>
                <a href="/projectttttttt/view/frontoffice/modules/cancelInscription.php?id_event=<?php echo htmlspecialchars((int)$_GET['id_event']); ?>" class="back-link" style="margin-top: 12px; display:inline-flex;">
            ...
            <a href="/projectttttttt/index.php?page=events" class="back-link">
