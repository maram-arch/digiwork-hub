...
<header class="navbar">
  <div class="container navbar-content">
    ...
    <nav class="nav-links">
      ...
      <a href="/projectttttttt/index.php?page=projets" class="active">Projets</a>
...
<section class="hero">
  <div class="container">
    ...
    <div class="hero-buttons">
      <a href="/projectttttttt/index.php?page=explore" class="btn btn-white">All Projects</a>
...
<section class="section" id="projets">
  <div class="container">
    <div class="section-header">
      ...
      <a href="/projectttttttt/index.php?page=explore" class="see-more">All Projects</a>
    </div>
