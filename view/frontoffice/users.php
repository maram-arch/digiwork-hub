    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="card card-soft mb-4">
                <div class="card-body p-4">
                    <h5 class="mb-4">Distribution des Rôles</h5>
                    <p style="font-size: 13px; color: #999; margin-bottom: 20px;">Utilisateurs du site web</p>
                    <div class="row">
                        <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Rechercher par ID ou Email</label>
                                <input type="text" id="searchInput" class="form-control" placeholder="Entrez ID ou Email...">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div class="card card-soft">
                <div class="card-body p-4 table-responsive">
                    <h5 class="mb-3">Utilisateurs inscrits <span id="userCount" style="font-weight: normal; color: #666;">(0)</span></h5>
                    <table class="table table-hover align-middle" id="usersTable">
                        ...
                        <?php foreach ($users as $user): ?>
                            <tr class="user-row" data-id="<?= (int) $user['id_user'] ?>" data-email="<?= htmlspecialchars(strtolower($user['email']), ENT_QUOTES, 'UTF-8') ?>" data-role="<?= htmlspecialchars($user['role'], ENT_QUOTES, 'UTF-8') ?>">
...
<script src="frontoffice-users-dashboard.js"></script>
</body>
</html>
